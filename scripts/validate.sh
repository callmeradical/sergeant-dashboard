...
tailnet_host=${SERGEANT_TAILNET_HOST:-cleanthes.taila4fb6a.ts.net:443}
...
tailscale serve status --json | "$dashboard_bin" validate-serve "$tailnet_host" /sergeant http://127.0.0.1:8992/sergeant
